...
#define BOTMSG_CMD_START                  "Добро пожаловать в анонимный чат, %s! Для поиска собеседника введи <b><i>/find</i></b>"
...
#define BOTMSG_REGISTER_NEW_USER          "👤 Зарегистрировался новый пользователь!\n\n%s"
