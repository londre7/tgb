...
{
	SMAnsiString callback_token = RecvCallback->Data;
	SMAnsiString callback_id = callback_token.Delete(32, callback_token.length());
	SMAnsiString callback_type = callback_token.Delete(0, 33);
